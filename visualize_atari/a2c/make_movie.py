...
from saliency_maps.visualize_atari.a2c.rollout import rollout

def make_movie(env_name, env, model, checkpoint='*.tar', num_frames=20, first_frame=0, resolution=75, \
                save_dir='./saliency_maps/movies/', density=5, radius=5, prefix='default', overfit_mode=False):
